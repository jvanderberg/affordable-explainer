  ...
  return (
    <main>
      ...
      <section className="policy">
        ...
        <div className="policy-cards"><article><b>TARGETED SUBSIDY</b><h3>Protect people now.</h3><p>Essential for households the private market can’t serve. It is also expensive: recent city-supported projects in Chicago cost roughly $679,000 to $747,000 per unit, which limits how many we can build.</p><div className="source-links"><a href="https://citythatworks.substack.com/p/chicago-doubles-down-on-unaffordable" target="_blank" rel="noreferrer">City That Works cost analysis ↗</a></div><strong>Deep impact · limited volume</strong></article><div className="policy-plus" aria-hidden="true"><span>+</span></div><article><b>MARKET-RATE SUPPLY</b><h3>Make room at scale.</h3><p>Creates choices now, sets off chains of moves, and becomes the older, cheaper housing that future Oak Park residents will rely on.</p><strong>Broad impact · scalable</strong></article></div>
      </section>
